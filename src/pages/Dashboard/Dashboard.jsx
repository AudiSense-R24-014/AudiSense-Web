...
const Dashboard = () => {
    ...
    return (
        <div className="p-4 lg:px-10">
            <h1 className="text-3xl lg:text-4xl font-bold font-nunito">
                Dashboard
            </h1>
            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md grid grid-cols-1 xl:grid-cols-2 gap-4">
                ...
                {/* Right column: Numerical details */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 font-nunito">
                    <div className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center space-y-4">
                        ...
                        <button
                            className="bg-purple-500 text-white w-full px-4 py-2 rounded-md hover:bg-purple-900"
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center space-y-4">
                        ...
                        <button
                            className="bg-audi-blue text-white w-full px-4 py-2 rounded-md hover:bg-cyan-900"
