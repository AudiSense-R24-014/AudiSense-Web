      ...
      {generatedTasks.length > 0 && (
        <div className="mt-8">
          ...
          <button
            ...
            className={`mb-4 bg-audi-purple hover:bg-purple-900 text-white font-bold py-2 px-4 rounded ${
              assignedTasks.length === generatedTasks.length ? "bg-green-500" : ""
            }`}
          >
