          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr className="text-xs text-gray-700 text-left font-bold uppercase tracking-wider">
                ...
                <th className="px-6 py-3">Clinician Provided Context</th>
            ...
            >
              {allFeedback
                ...
                .reverse()
                .map((feedback) => (
                  <tr key={feedback._id} className="text-sm text-gray-600">
                    <td className="px-6 py-4 whitespace-nowrap">
                      {feedback.Input_Age}
                    </td>
                    <td className="px-6 py-4 whitespace-pre-wrap">
                      {feedback.Input_Context ? feedback.Input_Context : "N/A"}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      {feedback.Input_Length.charAt(0).toUpperCase() +
                        feedback.Input_Length.slice(1).toLowerCase()}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
